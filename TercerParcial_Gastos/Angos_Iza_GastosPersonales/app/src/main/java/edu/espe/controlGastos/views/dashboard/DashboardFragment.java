package edu.espe.controlGastos.views.dashboard;
...
public class DashboardFragment extends Fragment {
    ...
    private void showBalanceTimelineCard(){
        ...
        if(budget > 0){
            ...
            LineDataSet budgetDataSet = new LineDataSet(budgetEntries, "Presupuesto Mensual Máximo");
        ...
        LineDataSet incomeDataSet = new LineDataSet(balanceEntries, "Balance Diario");
    ...
    private void showMonthlyBudgetCard(){
        ...
        budgetRemaining.setText("Restante " + symbol + remaning);
